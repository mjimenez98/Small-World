...
void Random::picks_race(vector<FantasyRaceBanner> &raceBanners) {
...
void Random::playerTurn(vector<FantasyRaceBanner>& raceBanners) {

    int declineChoice = 1 + rand() % 10;
    ...
    // If randomly generated number is between 1 and 5, decline the race, else ready troops
    else if (declineChoice > 0 && declineChoice < 6) {
        decline();
    }
    else {
        readyTroops();
